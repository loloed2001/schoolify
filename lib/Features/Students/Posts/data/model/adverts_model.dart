...
List<IndexAdvertsModel> indexAdvertsModelFromJson(String str) =>
    List<IndexAdvertsModel>.from(
        json.decode(str).map((x) => IndexAdvertsModel.fromJson(x)));

String indexAdvertsModelToJson(List<IndexAdvertsModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class IndexAdvertsModel {
  ...
  factory IndexAdvertsModel.fromJson(Map<String, dynamic> json) =>
      IndexAdvertsModel(
