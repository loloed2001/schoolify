...
List<ExamprogramModel> examprogramModelFromJson(String str) =>
    List<ExamprogramModel>.from(
        json.decode(str).map((x) => ExamprogramModel.fromJson(x)));

String examprogramModelToJson(List<ExamprogramModel> data) =>
...
class ExamprogramModel {
  ...
  factory ExamprogramModel.fromJson(Map<String, dynamic> json) =>
      ExamprogramModel(
        id: json["id"],
        name: json["name"],
        type: json["type"],
